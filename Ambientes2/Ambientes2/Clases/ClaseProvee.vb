...
Public Class ClaseProvee
    ...
    Dim columnas As String = "idproveedor as Numero,nombre as Nombre,rfc as RFC,telefono1 as Telefono1, telefono2 as Telefono2, fax as Fax, direccion as Direccion, codigopostal as CodigoPostal, email as Email, personacontacto as Contacto"
    Dim nombreid As String = "idproveedor"
    Public Sub New()
    End Sub
    Public Function consultaID(ByVal id As String, ByVal dtg As DataGridView) As Boolean
        ...
        Dim DT As DataTable
        Dim query As String = "Select " & columnas & " from " & tabla & " where rfc like '" & id & "%' and estado = 'A'"
        Try
    ...
    Public Function actualiza(ByVal nombre As String, ByVal newrfc As String, ByVal tel1 As String, ByVal tel2 As String, ByVal fax As String, ByVal dir As String, ByVal codigo As String, ByVal email As String, ByVal contacto As String, ByVal id As String) As Boolean
        Dim strSql As String
        Dim xCnx As New Conexion

        strSql = "UPDATE " & tabla & " SET nombre = '" & nombre & "',telefono1 = '" & tel1 & "',fax = '" & fax & "',telefono2 = '" & tel2 & "',rfc = '" & newrfc & "',email = '" & email & "',personacontacto = '" & contacto & "',codigopostal = '" & codigo & "' WHERE " & nombreid & " = '" & id & "';"
        xCnx.queryStr(strSql)
